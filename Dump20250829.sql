...
CREATE TABLE `departments` (
  ...
  KEY `fk_departments_stream` (`stream_id`),
  CONSTRAINT `fk_departments_stream` FOREIGN KEY (`stream_id`) REFERENCES `streams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'timetable_system'
--

--
-- Dumping routines for database 'timetable_system'
--
...
-- Dump completed on 2025-08-29 13:34:46
