...
<div class="main-content" id="mainContent">
	<div class="table-container">
		...
		<table class="table table-striped m-3">
			<thead>
				<tr><th>Start</th><th>End</th><th>Duration (min)</th><th>Break</th><th>Mandatory</th><th>Actions</th></tr>
			</thead>
			<tbody>
...
<div class="modal fade" id="addTimeSlotModal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header"><h5 class="modal-title">Add Time Slot</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
			<form method="post">
				<div class="modal-body">
					...
					<div class="mb-3"><label class="form-label">Duration (minutes)</label><input type="number" name="duration" class="form-control" value="60" required></div>
					<div class="form-check mb-3"><input type="checkbox" name="is_break" class="form-check-input" id="add_ts_break"><label class="form-check-label" for="add_ts_break">Is Break</label></div>
					<div class="form-check mb-3"><input type="checkbox" name="is_mandatory" class="form-check-input" id="add_ts_mand" checked><label class="form-check-label" for="add_ts_mand">Is Mandatory</label></div>
				</div>
